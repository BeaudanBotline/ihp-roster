...
| --- | --- | --- | --- |
| Account and tenant records | users, tenant admins, tenant metadata | Retain while service is active and for a reasonable post-termination period | Needed for support, billing and audit |
